...
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8 COMMENT='Stores block settings, such as region and visibility...';
...
CREATE TABLE IF NOT EXISTS `file_managed` (
  ...
  KEY `file_type` (`type`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='Stores information for uploaded files.';
...
) ENGINE=InnoDB AUTO_INCREMENT=412 DEFAULT CHARSET=utf8 COMMENT='Contains the individual links within a menu.';
...
) ENGINE=InnoDB AUTO_INCREMENT=1056 DEFAULT CHARSET=utf8 COMMENT='Table that contains logs of all system events.';
